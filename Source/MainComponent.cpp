...
{
    titleLabel.setText ("Tight-WFS — dense-array Wave Field Synthesis", juce::dontSendNotification);
    ...
    deviceSelector = std::make_unique<juce::AudioDeviceSelectorComponent> (
        ...
        0, 64,     // output channels: min, max (dense arrays raise this later)
        false,     // MIDI in
        false,     // MIDI out
    ...
    // 2 in / 2 out to start with; the dense-array renderer will renegotiate
...
void MainComponent::getNextAudioBlock (const juce::AudioSourceChannelInfo& bufferToFill)
{
    ...
    // WFS delay-and-sum renderer (spatcore/wfs) replaces this.
    float peak = 0.0f;
...
void MainComponent::timerCallback()
{
    ...
    juce::String status;
    status << "dense-array WFS  ·  reuses spatcore/wfs delay-and-sum";
